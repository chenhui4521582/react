	...
	render() {
		...
		return(
			<div className="index">
				...
				<hr></hr>
				<main>
          <Route exact path="/demo/cssmodule" component={CssModule}></Route>
          <Route path='/demo/cssmodule' exact component={CssModule} />
          <Route exact path="/demo/setstate" component={SetState}></Route>
          <Route exact path="/demo/concat" component={Concat}></Route>
          <Route exact path="/demo/model" component={Model}></Route>
				</main>
			</div>
		)
	}
