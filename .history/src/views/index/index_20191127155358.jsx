	...
	constructor(props) {
		...
		this.state = {
			nav: [
				...
				{name: 'state状态更新', className: 'state-update', url: '/index/cssModule'},
				{name: '父子组件传递参数', className: 'css-module', url: '/index/cssModule'},
				{name: '双向数据绑定', className: 'css-module', url: '/index/cssModule'}
			]
		}
	}
	render() {
